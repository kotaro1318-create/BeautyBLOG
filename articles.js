...
const ARTICLES = [
  ...
  {
    title: "お風呂上がりの保湿、何分以内が勝負?「モイスチャライズウィンドウ」の科学",
    date: "2026-09-05",
  ...
  {
    title: "目の下の「くま」、実は3種類。原因が違えばケアも変わります",
    date: "2026-09-06",
  ...
  {
    title: "保湿剤、実は塗る量が全然足りていないかもしれません。「FTU」という目安",
    date: "2026-09-08",
  ...
  {
    title: "そのシミ、原因は1つじゃない。見分けにくい4タイプとケアの落とし穴",
    date: "2026-09-09",
  ...
  {
    title: "自宅ピーリングと医療ピーリング、境界線を分ける「3.6%」という数字",
    date: "2026-09-10",
  ...
  {
    title: "顔のたるみ、皮膚だけのせいじゃなかった。骨・脂肪・靱帯も一緒に老化するという話",
    date: "2026-09-11",
  ...
  {
    title: "手洗いのしすぎで手荒れが悪化?正しい洗い方と保湿剤の選び方",
    date: "2026-09-12",
  ...
  {
    title: "生理前の肌荒れ、気のせいじゃなかった。女性ホルモンが肌を動かす仕組み",
    date: "2026-09-16",
    conclusion: "月経周期に伴うエストロゲンとプロゲステロンの増減が皮脂量や肌のハリを周期的に変化させており、月経前に肌が荒れやすくなるのには生理学的な裏付けがあります。",
    body: "「生理前になると決まって同じ場所にニキビができる」という感覚、実はれっきとした根拠があります。月経周期はだいたい28日前後(26〜30日は正常範囲とされます)で、その中でエストロゲンとプロゲステロンという2種類の女性ホルモンの分泌量が波のように上下しています。エストロゲンは皮下脂肪の発育を助けたり肌のハリを支えたりするほか、皮脂腺の働きを抑える方向にも働くホルモンです。一方、月経前の黄体期に増えるプロゲステロンは男性ホルモンに似た性質を持ち、体温を上げたり皮脂腺を活発にしたりする働きがあるとされています。月経前症候群(PMS)は生理の3〜10日前から始まることが多いとされ、ちょうどこの時期にプロゲステロンが優位になることで皮脂分泌が増え、ニキビや肌荒れが悪化しやすくなる、というわけです。肌への影響を左右するのはホルモンの絶対量だけでなく、男性ホルモンと女性ホルモンの「比率」だとも言われています。同じ仕組みは妊娠中にも働き、エストロゲンの急増で妊娠性の肝斑や色素沈着が起こることがありますが、これらの多くは出産後1〜2ヶ月ほどで自然に消退していくとされています。肌の調子が悪いなと感じたら、スキンケアを変える前にまずカレンダーを見返してみるのもよさそうです。",
    visual: "\n      <div class=\"viz\">\n        <p class=\"viz-title\">表:月経周期のフェーズとホルモン・肌への影響の傾向</p>\n        <div class=\"viz-table-wrap\">\n          <table class=\"viz-table\">\n            <thead>\n              <tr><th>フェーズ</th><th>主なホルモンの動き</th><th>肌への影響の傾向</th></tr>\n            </thead>\n            <tbody>\n              <tr><td>月経期</td><td>両ホルモンとも低下</td><td>ハリ・うるおいが落ちやすい</td></tr>\n              <tr><td>卵胞期</td><td>エストロゲンが上昇</td><td>皮脂が落ち着き調子が上がりやすい</td></tr>\n              <tr><td>排卵期</td><td>エストロゲンがピーク</td><td>ハリ・ツヤが出やすい</td></tr>\n              <tr><td>黄体期(生理前)</td><td>プロゲステロンが優位に</td><td>皮脂↑、ニキビ・肌荒れ(PMS)</td></tr>\n            </tbody>\n          </table>\n        </div>\n      </div>\n      <div class=\"viz\">\n        <p class=\"viz-title\">図:知っておきたい数字</p>\n        <div class=\"viz-stats\">\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">26〜30日</span>\n            <span class=\"stat-label\">月経周期の正常範囲の目安(平均28日前後)</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">3〜10日前</span>\n            <span class=\"stat-label\">PMS(月経前症候群)による肌荒れが始まりやすい時期</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">産後1〜2ヶ月</span>\n            <span class=\"stat-label\">妊娠性肝斑の多くが自然に消退するまでの目安</span>\n          </div>\n        </div>\n      </div>\n    ",
    sources: [
      { label: "『美容のヒフ科学』(安田利顕)" },
      { label: "『美容の科学』(日本コスメティック協会)" }
    ]
  ...
  {
    title: "その洗顔、実は逆効果かも。クレンジング・洗顔の「量と温度」あるある誤解",
    date: "2026-09-17",
    conclusion: "クレンジングも洗顔も「少なめ・熱め」より「たっぷり・ぬるめ」が肌への摩擦と乾燥を防ぐ基本で、思い込みで逆をしている人は少なくなさそうです。",
    body: "「クレンジングは摩擦を減らすために少なめに」「洗顔は朝、水だけで十分」——こうした思い込み、実は肌への負担を増やしているかもしれません。クレンジング料は量が少ないと肌の上で滑らずこすれてしまい、摩擦による色素沈着の原因にもなります。目安はクリームタイプでさくらんぼ1粒大、オイルタイプで500円玉大ほど。肌の上でスルスル動くくらいたっぷり使うのが正解です。ウォータープルーフの日焼け止めやファンデーションを使った日は、洗顔料だけで落とそうとして余計にこすってしまう前に、クレンジング料に頼るほうが肌にはやさしいはず。洗顔のお湯は熱いほうがさっぱりする気がしますが、皮脂が溶け出すのはおよそ30℃前後からなので、32〜34℃のぬるま湯がちょうどいいバランスとされています。熱すぎると必要な皮脂まで奪って乾燥を招きます。泡立てネットに固形石けんを直接こすりつけると、ネットに保湿成分が余分に取られて肌の水分蒸発量が増えるとも言われるため、まず手のひらで石けんを転がしてから泡立てるのがコツ。目安は「レモン1個分」のきめ細かい泡です。そして見落としがちなのが、髪の生え際・フェイスライン・首まわりのすすぎ残し。洗い終えたと思ってからもう一往復流すひと手間が、ニキビや肌荒れの予防につながるようです。",
    visual: "\n      <div class=\"viz\">\n        <p class=\"viz-title\">表:クレンジング・洗顔の「あるある誤解」</p>\n        <div class=\"viz-table-wrap\">\n          <table class=\"viz-table\">\n            <thead>\n              <tr><th>項目</th><th>よくある思い込み</th><th>実は</th></tr>\n            </thead>\n            <tbody>\n              <tr><td>クレンジングの量</td><td>少なめの方が肌に優しい</td><td>たっぷりのせてスルスル動く量が正解</td></tr>\n              <tr><td>洗顔のお湯</td><td>熱いお湯でさっぱり落とす</td><td>32〜34℃のぬるま湯が皮脂を落としつつ乾燥を防ぐ</td></tr>\n              <tr><td>泡立て方</td><td>ネットに石けんを直接こすりつける</td><td>手のひらで転がしてからネットで泡立てる</td></tr>\n              <tr><td>すすぎ</td><td>顔全体を流せば完了</td><td>生え際・フェイスライン・首をもう一往復</td></tr>\n            </tbody>\n          </table>\n        </div>\n        <p class=\"viz-note\">出典:『コスメの教科書』(日本化粧品検定協会)</p>\n      </div>\n      <div class=\"viz\">\n        <p class=\"viz-title\">図:覚えておきたい目安</p>\n        <div class=\"viz-stats\">\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">32〜34℃</span>\n            <span class=\"stat-label\">洗顔・すすぎに適したお湯の温度</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">レモン1個分</span>\n            <span class=\"stat-label\">きめ細かい洗顔の泡の目安量</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">500円玉大</span>\n            <span class=\"stat-label\">オイルタイプのクレンジング料の使用量目安</span>\n          </div>\n        </div>\n      </div>\n    ",
    sources: [
      { label: "『コスメの教科書』(日本化粧品検定協会)" },
      { label: "『やさしく伝えるスキンケア実践ガイド』(野村有子)" }
    ]
  ...
  {
    title: "その頬のシミ、レーザーで悪化するかも。「治療してはいけないシミ」肝斑の話",
    date: "2026-09-19",
    conclusion: "肝斑は通常のシミ取りレーザーでかえって悪化することがあるため、まず内服・外用で整え、それでも残る場合だけ専用の低出力レーザーを検討するのが安全な順番とされています。",
    body: "「シミ=レーザーで一発解決」というイメージ、実は当てはまらないシミがあります。それが頬骨のあたりに左右対称の淡い褐色斑として出やすい「肝斑」です。老人性色素斑などに使う通常のシミ取りレーザーは、メラニンそのものを高熱で破壊する仕組みなのですが、これを肝斑に通常通り当てると、逆に炎症後色素沈着を起こしてかえって色が濃くなってしまうリスクが指摘されています。そのため肝斑にはまず、トラネキサム酸の内服やハイドロキノンの外用、徹底した紫外線対策といった保存的な治療が基本とされ、レーザーはいきなり選ぶ手段ではありません。それでも色素が残る場合の次の一手として考案されたのが「レーザートーニング」です。通常より低い出力のレーザーを、かさぶたを作らないように当てる方法で、メラニンを壊すというより表皮のターンオーバーを緩やかに促して色素を排出させるイメージに近いとされています。1週間に1回ほどのペースで重ね、3〜5回あたりから効果を感じ始める人が多い一方、回数を重ねすぎたり同じ場所に打ちすぎると、今度は逆に白く色が抜けてしまうリスクもあるようです。老人性色素斑と肝斑が混ざって出ているケースも珍しくないため、まずは自己判断せず正しく見分けてもらうことが遠回りに見えて一番の近道なのかもしれません。",
    visual: "\n      <div class=\"viz\">\n        <p class=\"viz-title\">表:通常のシミ取りレーザーとレーザートーニングの違い</p>\n        <div class=\"viz-table-wrap\">\n          <table class=\"viz-table\">\n            <thead>\n              <tr><th>項目</th><th>通常のシミ取りレーザー</th><th>レーザートーニング</th></tr>\n            </thead>\n            <tbody>\n              <tr><td>出力</td><td>高出力</td><td>低出力</td></tr>\n              <tr><td>仕組み</td><td>メラニンを高熱で破壊</td><td>軽い熱刺激でターンオーバーを促進</td></tr>\n              <tr><td>施術後</td><td>かさぶたができやすい</td><td>かさぶたを作らないよう照射</td></tr>\n              <tr><td>肝斑への使用</td><td>悪化のリスクあり</td><td>保存的治療後の選択肢として検討</td></tr>\n            </tbody>\n          </table>\n        </div>\n        <p class=\"viz-note\">出典:Monthly Book Derma. No.262「再考!美容皮膚診療」</p>\n      </div>\n      <div class=\"viz\">\n        <p class=\"viz-title\">図:レーザートーニングの目安</p>\n        <div class=\"viz-stats\">\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">1週間に1回</span>\n            <span class=\"stat-label\">施術頻度の目安</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">3〜5回</span>\n            <span class=\"stat-label\">効果を感じ始める回数の目安</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">重ね打ち注意</span>\n            <span class=\"stat-label\">回数が多すぎると白斑(色素脱失)のリスク</span>\n          </div>\n        </div>\n      </div>\n    ",
    sources: [
      { label: "Monthly Book Derma. No.262「再考!美容皮膚診療-自然な若返りを望む患者への治療のコツ-」(森脇真一 編集企画)" },
      { label: "『美容皮膚Q&A』(川田暁)" }
    ]
  ...
  {
    title: "その爪の白濁、水虫と決めつけないで。見分けにくい爪トラブルたち",
    date: "2026-09-20",
    conclusion: "爪の変色や変形は爪水虫だけが原因とは限らず、カンジダ症や加齢による変形、全身疾患のサインであることもあるため、見た目だけの自己判断には注意が必要とされています。",
    body: "「爪が白っぽく濁ってきた」「厚くなった」と聞くと、まず思い浮かぶのは水虫(爪白癬)かもしれません。ですが実際には、似たような見た目でも原因が異なる爪トラブルがいくつも存在します。爪白癬の診断は本来、爪を少し採取してKOH溶液で溶かし顕微鏡で観察する「直接鏡検」が基本で、見た目だけで判断するのは実は難しいとされています。さらに紛らわしいのが、手の爪が濁っているケース。手は口や陰部など、カンジダ菌がいる部位に触れる機会が多いため、足の爪水虫よりも「爪カンジダ症」であることが少なくないそうです。また高齢者の足の親指に多い「厚硬爪甲」や「爪甲鉤彎症」は、爪が分厚く変形する点は水虫と似ていますが、爪のもろさや爪の下の角質増殖を伴わないのが見分けるポイント。これらは薬より、定期的なニッパーでの爪切りが生活の質の改善に直結するとされています。まれに、爪がすべて均一に黄色く変化し、リンパ浮腫や呼吸器の病気を伴う「黄色爪症候群」という全身性の病気が隠れていることも。爪の変化は、思った以上にいろいろな体のサインを映し出しているようです。",
    visual: "\n      <div class=\"viz\">\n        <p class=\"viz-title\">表:爪に現れる変化とその正体</p>\n        <div class=\"viz-table-wrap\">\n          <table class=\"viz-table\">\n            <thead>\n              <tr><th>サイン</th><th>考えられる原因</th><th>見分けるポイント</th></tr>\n            </thead>\n            <tbody>\n              <tr><td>足の爪が白濁し分厚くなる</td><td>爪白癬(爪水虫)</td><td>直接鏡検(KOH法)による確定診断が基本</td></tr>\n              <tr><td>手の爪が濁る</td><td>爪カンジダ症</td><td>口・陰部に触れやすい手に多いとされる</td></tr>\n              <tr><td>高齢者の親指の爪が分厚く曲がる</td><td>厚硬爪甲・爪甲鉤彎症</td><td>もろさや爪下の角質増殖を伴わない</td></tr>\n              <tr><td>爪全体が均一に黄色くなる</td><td>黄色爪症候群</td><td>リンパ浮腫・呼吸器疾患を伴うことも</td></tr>\n            </tbody>\n          </table>\n        </div>\n        <p class=\"viz-note\">出典:『美容の科学』(日本コスメティック協会)</p>\n      </div>\n      <div class=\"viz\">\n        <p class=\"viz-title\">図:爪白癬をめぐる基礎知識</p>\n        <div class=\"viz-stats\">\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">4病型</span>\n            <span class=\"stat-label\">爪白癬はDLSO・SWO・PSO・TDOの4つの病型に分類される</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">直接鏡検</span>\n            <span class=\"stat-label\">KOH溶液で爪を溶かし顕微鏡で観察する診断法が基本とされる</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">定期的な爪切り</span>\n            <span class=\"stat-label\">厚硬爪甲はニッパーでの爪切りがQOL改善に直結するとされる</span>\n          </div>\n        </div>\n      </div>\n    ",
    sources: [
      { label: "『美容の科学』(日本コスメティック協会)" },
      { label: "『美容のヒフ科学』(安田利顕)" }
    ]
  ...
  {
    title: "そのシミ、実は盛り上がっていませんか?「脂漏性角化症」というありふれた良性のイボの話",
    date: "2026-09-22",
    conclusion: "茶色いポツポツの多くは加齢による良性の「脂漏性角化症」ですが、黒っぽい色や急な変化がある場合は自己判断せず皮膚科で確認したほうが安心とされています。",
    body: "顔や胸元、背中にできる茶色っぽいポツポツを「シミが濃くなった」と思い込んでいませんか?実はそれ、脂漏性角化症(老人性疣贅)と呼ばれる、加齢に伴うありふれた良性のイボかもしれません。紫外線を浴びやすい部位にできやすく、最初は平らなシミのように見えても、時間とともに表面がガサガサ・ザラザラと乾いた質感になり、次第に盛り上がってくるのが特徴です。痛みやかゆみは基本的になく、それ自体は健康上心配のいらないものとされています。ただしややこしいのが、黒っぽい色調になったものは、見た目だけでは悪性黒色腫や基底細胞癌と区別がつきにくいことがある点。自己判断で「イボだから平気」と放置するのは避けたいところです。基本的に治療の必要はありませんが、見た目が気になる場合や診断を確定させたい場合は、液体窒素による凍結療法や炭酸ガスレーザーでの除去も選択肢になります。さらに知っておきたいのが、急に数が増えたり大きさが変化したりする場合。まれに体の中の別の病気を知らせるサイン(Leser-Trelat徴候)である可能性も指摘されており、変化に気づいたら自己判断せず皮膚科を受診するのが安心です。",
    visual: "\n      <div class=\"viz\">\n        <p class=\"viz-title\">表:茶色いポツポツ、見分け方の目安</p>\n        <div class=\"viz-table-wrap\">\n          <table class=\"viz-table\">\n            <thead>\n              <tr><th>サイン</th><th>考えられる正体</th><th>見分けるポイント</th></tr>\n            </thead>\n            <tbody>\n              <tr><td>平らな茶色いシミ</td><td>老人性色素斑</td><td>表面は滑らかで盛り上がらない</td></tr>\n              <tr><td>ガサガサして盛り上がる</td><td>脂漏性角化症(老人性疣贅)</td><td>基本的に良性、経過観察でよいことが多い</td></tr>\n              <tr><td>黒っぽく形がいびつ</td><td>悪性黒色腫の可能性も</td><td>見た目だけでの判別は難しく受診が必要</td></tr>\n              <tr><td>急に数・大きさが変化</td><td>Leser-Trelat徴候の可能性</td><td>内臓疾患のサインのことがあり要受診</td></tr>\n            </tbody>\n          </table>\n        </div>\n        <p class=\"viz-note\">出典:『美容の科学』(日本コスメティック協会)</p>\n      </div>\n      <div class=\"viz\">\n        <p class=\"viz-title\">図:脂漏性角化症をめぐる基礎知識</p>\n        <div class=\"viz-stats\">\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">良性の上皮性腫瘍</span>\n            <span class=\"stat-label\">加齢と紫外線の蓄積によって顔・頭部・体幹にできやすい</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">基本は経過観察</span>\n            <span class=\"stat-label\">痛み・かゆみはなく治療の必要はないとされる</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">凍結療法・炭酸ガスレーザー</span>\n            <span class=\"stat-label\">気になる場合や鑑別目的で除去する選択肢もある</span>\n          </div>\n        </div>\n      </div>\n    ",
    sources: [
      { label: "『美容の科学』(日本コスメティック協会)" },
      { label: "『美容皮膚Q&A』(川田暁)" }
    ]
  ...
  {
    title: "下まぶたのプツプツ、実はニキビでもホクロでもない「汗管腫」かもしれません",
    date: "2026-09-23",
    conclusion: "下まぶたにできる肌色の小さなブツブツの多くは汗腺由来の良性腫瘍「汗管腫」で、決定的な治療法はまだなく再発しやすいとされています。",
    body: "下まぶたに肌色の小さなポツポツが並んでいて、ニキビでもホクロでもなさそうなのに気になる、という経験はありませんか。それ、「汗管腫(かんかんしゅ)」という、体温調節を担うエクリン汗腺の管の部分の細胞が増えてできる、ありふれた良性腫瘍かもしれません。悪性化の心配はほぼないとされていますが、特に女性の下まぶたにできやすく、女性ホルモンの関与が指摘されているほか、汗の分泌が増える夏場は目立ちやすくなる傾向もあるようです。ダウン症候群では発症率が高いという報告もあり、体質的な要因も関わっているとみられています。厄介なのは、これといった「決定打」の治療法がまだないこと。炭酸ガスレーザーや電気焼灼、凍結療法などで小さくすることはできますが、汗管の根っこまで完全に取りきるのは難しく、再発したり跡が色素沈着や瘢痕として残ったりするリスクもあります。確実に取りきるには切除という方法もありますが、保険が適用されるのはこの切除術のみで、レーザーなどは基本的に自費診療になる点も知っておきたいところです。気になっても自己判断でつぶしたりせず、皮膚科での相談をおすすめします。",
    visual: "\n      <div class=\"viz\">\n        <p class=\"viz-title\">図:汗管腫をめぐる基礎知識</p>\n        <div class=\"viz-stats\">\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">エクリン汗腺由来</span>\n            <span class=\"stat-label\">体温調節を担う汗の通り道の細胞が増えてできる良性腫瘍</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">女性の下まぶたに好発</span>\n            <span class=\"stat-label\">女性ホルモンの関与が指摘され、夏場は発汗増加で目立ちやすい</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">ダウン症候群で発症率↑</span>\n            <span class=\"stat-label\">体質的な要因も関わっているとみられている</span>\n          </div>\n        </div>\n      </div>\n      <div class=\"viz\">\n        <p class=\"viz-title\">表:汗管腫の主な治療法と保険適用</p>\n        <div class=\"viz-table-wrap\">\n          <table class=\"viz-table\">\n            <thead>\n              <tr><th>治療法</th><th>特徴</th><th>保険適用</th></tr>\n            </thead>\n            <tbody>\n              <tr><td>炭酸ガスレーザー</td><td>小さくできるが再発しやすい</td><td>適用外</td></tr>\n              <tr><td>電気焼灼</td><td>同上。色素沈着・瘢痕のリスクあり</td><td>適用外</td></tr>\n              <tr><td>凍結療法</td><td>同上。決定打にはならない</td><td>適用外</td></tr>\n              <tr><td>切除術</td><td>根治的だが傷跡が残ることも</td><td>適用</td></tr>\n            </tbody>\n          </table>\n        </div>\n        <p class=\"viz-note\">出典:『美容皮膚Q&A』(川田暁 編著)</p>\n      </div>\n    ",
    sources: [
      { label: "『美容皮膚Q&A』(川田暁 編著)" },
      { label: "『美容のヒフ科学』(安田利顕)" }
    ]
  ...
  {
    title: "化粧品でヒリヒリ・赤み。それ「刺激性」と「アレルギー性」、原因も見分け方も違います",
    date: "2026-09-24",
    conclusion: "化粧品による肌トラブルには誰にでも起こりうる「刺激性接触皮膚炎」と、特定の成分に免疫が反応する「アレルギー性接触皮膚炎」の2種類があり、仕組みも見分け方も異なるとされています。",
    body: "新しい化粧品を使った途端に肌がヒリヒリ・赤くなると、「肌に合わなかった」とひとまとめにしがちですが、実は仕組みの違う2タイプがあるとされています。ひとつは「刺激性接触皮膚炎」。強い刺激物質なら誰の肌にも起こりうるタイプで、強い刺激なら1回で急性に、弱い刺激でも繰り返せばバリア機能が弱って慢性的に起こることもあります。理美容師さんの手荒れのように、洗浄剤や水仕事への日常的な接触が積み重なって起こるケースもこちらです。もうひとつが「アレルギー性接触皮膚炎」。免疫の記憶が関わるタイプで、まず皮膚の免疫細胞が原因物質を捕まえてリンパ節に運び、体に「これは異物」と覚え込ませる「感作」という段階を経ます。感作が一度成立すると、次に同じ成分に触れたときだけ免疫細胞が一気に反応し、かぶれが起こる「惹起」が生じます。原因物質の多くは分子量の小さい物質で、単独では無害でも体内のタンパク質とくっつくことで初めて「敵」とみなされるのも特徴です。皮膚科のパッチテストでは、貼った場所の周りにまで反応が広がるかどうかが、刺激性かアレルギー性かを見分ける手がかりの一つとされています。「前は平気だったのに急に荒れた」という場合、アレルギー性の可能性も視野に入れてみる価値がありそうです。",
    visual: "\n      <div class=\"viz\">\n        <p class=\"viz-title\">表:刺激性とアレルギー性、接触皮膚炎の違い</p>\n        <div class=\"viz-table-wrap\">\n          <table class=\"viz-table\">\n            <thead>\n              <tr><th></th><th>刺激性接触皮膚炎</th><th>アレルギー性接触皮膚炎</th></tr>\n            </thead>\n            <tbody>\n              <tr><td>起こる相手</td><td>強い刺激なら誰にでも</td><td>感作が成立した人だけ</td></tr>\n              <tr><td>初回の接触</td><td>強い刺激ならすぐ発症</td><td>症状は出ない(感作のみ)</td></tr>\n              <tr><td>発症までの経過</td><td>急性 or 繰り返しの蓄積</td><td>感作後、再接触で「惹起」</td></tr>\n              <tr><td>パッチテスト</td><td>貼付部位周囲への拡大なし</td><td>貼付部位周囲にも反応が拡大</td></tr>\n            </tbody>\n          </table>\n        </div>\n        <p class=\"viz-note\">出典:『美容の科学』(日本コスメティック協会)</p>\n      </div>\n      <div class=\"viz\">\n        <p class=\"viz-title\">図:アレルギー性接触皮膚炎が成立する2段階</p>\n        <div class=\"viz-stats\">\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">感作相</span>\n            <span class=\"stat-label\">皮膚の免疫細胞が原因物質を捕捉し、リンパ節で「敵」として記憶させる</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">惹起相</span>\n            <span class=\"stat-label\">同じ成分に再接触した際、記憶した免疫細胞が皮膚内で反応しかぶれが起こる</span>\n          </div>\n        </div>\n        <p class=\"viz-note\">出典:『あたらしい美容皮膚科学』(日本美容皮膚科学会)</p>\n      </div>\n    ",
    sources: [
      { label: "『美容の科学』(日本コスメティック協会)" },
      { label: "『あたらしい美容皮膚科学』(日本美容皮膚科学会)" }
    ]
  ...
  {
    title: "その円形の抜け毛、実は自己免疫かも。治療と両立させたいヘアケアの工夫",
    date: "2026-09-25",
    conclusion: "円形脱毛症は自分の免疫が毛包を誤って攻撃してしまう自己免疫疾患と考えられており、治療と並行した日々のヘアケアの工夫が負担を減らす助けになります。",
    body: "ある朝、丸く髪が抜けているのに気づいて驚いた経験はありませんか。円形脱毛症は「ストレスのせい」と語られがちですが、実は自分の免疫細胞が誤って毛包の成分を攻撃してしまう自己免疫疾患だと考えられています。脱毛の範囲によって、1か所だけの単発型から、複数箇所に広がる多発型、頭部全体に及ぶ全頭型、体毛全体まで及ぶ汎発型などに分類され、白斑や慢性甲状腺炎といった別の自己免疫疾患を合併しやすいことも報告されています。診断では、ダーモスコピーという機器で毛の太さのばらつきを確認する方法がよく使われるそうです。治療と並行して見直したいのが毎日のヘアケア。シャンプーは洗浄力の強すぎる成分を避け、アミノ酸系洗浄成分やセラミドなどの保湿成分を含む低刺激タイプを選び、42℃以下のぬるま湯で指の腹を使い1日1回までを目安にするとよいとされています。ポニーテールやきつい編み込みは、頭皮を引っ張り続けることで別の脱毛(牽引性脱毛症)を招くリスクがあるため、緩めのまとめ髪への切り替えがすすめられています。高温のアイロンや頻繁なパーマ・カラーも頭皮の負担になりやすく、さらに喫煙は円形脱毛症の発症リスクを高めるとの報告もあるようです。ウィッグやスカーフの活用、患者会など心理的なサポートも回復を支える大切な要素とされています。",
    visual: "\n      <div class=\"viz\">\n        <p class=\"viz-title\">表:円形脱毛症の主な病型</p>\n        <div class=\"viz-table-wrap\">\n          <table class=\"viz-table\">\n            <thead>\n              <tr><th>病型</th><th>特徴</th></tr>\n            </thead>\n            <tbody>\n              <tr><td>単発型</td><td>脱毛斑が1か所</td></tr>\n              <tr><td>多発型</td><td>脱毛斑が複数箇所</td></tr>\n              <tr><td>全頭型</td><td>頭部全体に脱毛が拡大</td></tr>\n              <tr><td>汎発型</td><td>頭髪以外の体毛にも脱毛が拡大</td></tr>\n              <tr><td>蛇行型</td><td>生え際に沿って帯状に脱毛が広がる</td></tr>\n            </tbody>\n          </table>\n        </div>\n        <p class=\"viz-note\">出典:『美容の科学』(日本コスメティック協会)</p>\n      </div>\n      <div class=\"viz\">\n        <p class=\"viz-title\">図:避けたいスタイリングと代替案</p>\n        <div class=\"viz-stats\">\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">きつい結び髪</span>\n            <span class=\"stat-label\">ポニーテール・編み込みは牽引性脱毛症のリスク→緩めのまとめ髪へ</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">高温アイロン</span>\n            <span class=\"stat-label\">頭皮の負担に→120℃以下+ヒートプロテクト剤が目安</span>\n          </div>\n          <div class=\"stat-tile\">\n            <span class=\"stat-value\">頻繁なパーマ・カラー</span>\n            <span class=\"stat-label\">頭皮刺激になりやすい→ジアミンフリーやヘナも選択肢に</span>\n          </div>\n        </div>\n        <p class=\"viz-note\">出典:『やさしく伝えるスキンケア実践ガイド』(野村有子)</p>\n      </div>\n    ",
    sources: [
      { label: "『美容の科学』(日本コスメティック協会)" },
      { label: "『やさしく伝えるスキンケア実践ガイド』(野村有子)" }
    ]
